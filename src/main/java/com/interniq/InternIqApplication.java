...
public class InternIqApplication {
    ...
    @Bean
    @ConditionalOnProperty(name = "application.seed-demo-data", havingValue = "true", matchIfMissing = true)
    CommandLineRunner seedData(
        ...
        return args -> {
            ...
            createTestUser(userRepository, passwordEncoder, "Rahul Admin", "harsh20creates@gmail.com", Role.ADMIN, "Administration", null);
